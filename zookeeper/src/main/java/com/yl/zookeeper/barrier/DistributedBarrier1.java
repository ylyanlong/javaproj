 ...
 */
public class DistributedBarrier1 {
    private static final Logger LOG = LoggerFactory.getLogger(DistributedBarrier1.class);
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            LOG.info("主线程 移除栅栏 DONE!");
        } catch (Exception e) {
            LOG.error("barrier.removeBarrier Exception:{}", ExceptionUtils.getStackTrace(e));
        }
