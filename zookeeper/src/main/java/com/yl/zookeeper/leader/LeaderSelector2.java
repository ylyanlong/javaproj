 ...
 */
public class LeaderSelector2 extends LeaderSelectorListenerAdapter {
    private static final Logger LOG = LoggerFactory.getLogger(LeaderSelector2.class);
    private LeaderSelector selector;

    public static void main(String[] args){
        CuratorUtil curatorUtil = new CuratorUtil(ZkCommon.ZKADDRESS);
        LeaderSelector2 leaderSelector1 = new LeaderSelector2(curatorUtil.getCuratorFramework(), "/ylzktest/leaderSelect");
    ...
    public LeaderSelector2(CuratorFramework client, final String leaderPath){
