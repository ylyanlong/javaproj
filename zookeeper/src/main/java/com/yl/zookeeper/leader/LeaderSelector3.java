 ...
 */
public class LeaderSelector3 extends LeaderSelectorListenerAdapter {
    private static final Logger LOG = LoggerFactory.getLogger(LeaderSelector3.class);
    private LeaderSelector selector;

    public static void main(String[] args){
        CuratorUtil curatorUtil = new CuratorUtil(ZkCommon.ZKADDRESS);
        LeaderSelector3 leaderSelector1 = new LeaderSelector3(curatorUtil.getCuratorFramework(), "/ylzktest/leaderSelect");
    ...
    public LeaderSelector3(CuratorFramework client, final String leaderPath){
