 ...
 */
public class InterProcessMutex2 {
    private static final Logger LOG = LoggerFactory.getLogger(InterProcessMutex2.class);
    ...
    public static void main(String[] args){
        ...
        InterProcessMutex2 interProcessMutex1 = new InterProcessMutex2(curatorUtil.getCuratorFramework());
    ...
    public InterProcessMutex2(CuratorFramework client){
